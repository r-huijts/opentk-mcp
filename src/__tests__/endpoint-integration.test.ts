import { ApiService, BASE_URL } from '../services/api.js';
import { OdataService, ODATA_BASE_URL } from '../services/odata.js';
...
describe('Endpoint Integration Tests', () => {
  ...
  describe('ApiService Endpoints', () => {
    itLive('should fetch search results', async () => {
      const result = await apiService.search('kunstmatige intelligentie');
